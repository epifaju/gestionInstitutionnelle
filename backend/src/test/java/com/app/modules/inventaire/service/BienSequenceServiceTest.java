...
class BienSequenceServiceTest {

    @Mock private JdbcTemplate jdbcTemplate;
    @InjectMocks private BienSequenceService bienSequenceService;
    ...
    void nextSequence_siUpdateRetourneValeur_retourneValeur() {
        when(jdbcTemplate.query(anyString(), any(org.springframework.jdbc.core.RowMapper.class), eq(orgId), eq("MAT"), eq(2026)))
                .thenReturn(List.of(7));

        int seq = bienSequenceService.nextSequence(orgId, "MAT", 2026);
    ...
    void nextSequence_siUpdateVide_etRetryVide_lanceIllegalState() {
        ...
        assertThatThrownBy(() -> bienSequenceService.nextSequence(orgId, "MAT", 2026))
